      ...
      <div className="container" style={{ paddingTop: 'var(--space-8)', paddingBottom: 'var(--space-16)' }} id="org-public-profile">
        ...
        <Card className="p-0 mb-8 overflow-hidden relative animate-on-scroll" style={{ border: '2px solid var(--color-border)', borderRadius: 'var(--radius-lg)' }}>
          <div style={{
            ...
            {/* Background image or Checkerboard fallback */}
            <div style={{
              position: 'absolute',
        ...
        {(() => {
          ...
          return (
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--space-4)', marginBottom: 'var(--space-8)' }} className="animate-on-scroll">
              ...
              <Card className="p-3" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '8px', borderRadius: 'var(--radius-lg)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <div style={{ fontSize: '11px', fontWeight: '800', color: 'var(--color-text-muted)', letterSpacing: '0.05em' }}>TOURNAMENTS HOSTED</div>
                </div>
                <div className="dash-stat-value" style={{ fontSize: 'var(--text-xl)', color: '#3cc83c', lineHeight: '1', textShadow: '0 0 12px rgba(60, 200, 60, 0.4)' }}>{tournamentsHosted}+</div>
              </Card>
              ...
              <Card className="p-3" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '8px', borderRadius: 'var(--radius-lg)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <div style={{ fontSize: '11px', fontWeight: '800', color: 'var(--color-text-muted)', letterSpacing: '0.05em' }}>COMPETITORS REGISTERED</div>
                </div>
                <div className="dash-stat-value" style={{ fontSize: 'var(--text-xl)', color: '#38bdf8', lineHeight: '1', textShadow: '0 0 12px rgba(56, 189, 248, 0.4)' }}>{competitorsRegistered.toLocaleString()}+</div>
              </Card>
              ...
              <Card className="p-3" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '8px', borderRadius: 'var(--radius-lg)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <div style={{ fontSize: '11px', fontWeight: '800', color: 'var(--color-text-muted)', letterSpacing: '0.05em' }}>ACTIVE SERVERS</div>
                </div>
                <div className="dash-stat-value" style={{ fontSize: 'var(--text-xl)', color: '#3cc83c', lineHeight: '1', textShadow: '0 0 12px rgba(60, 200, 60, 0.4)' }}>{activeServers} ONLINE</div>
              </Card>
