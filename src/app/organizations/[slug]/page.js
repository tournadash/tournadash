          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--space-4)', marginBottom: 'var(--space-8)' }} className="animate-on-scroll">
            ...
            <Card className="p-1" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', borderRadius: 'var(--radius-lg)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center' }}>
                <div style={{ fontSize: '10px', fontWeight: '800', color: 'var(--color-text-muted)', letterSpacing: '0.05em', marginBottom: '2px' }}>TOURNAMENTS HOSTED</div>
                <div className="dash-stat-value" style={{ fontSize: 'var(--text-2xl)', color: '#3cc83c', lineHeight: '1', textShadow: '0 0 12px rgba(60, 200, 60, 0.4)' }}>{tournamentsHosted}+</div>
              </div>
            </Card>
            ...
            <Card className="p-1" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', borderRadius: 'var(--radius-lg)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center' }}>
                <div style={{ fontSize: '10px', fontWeight: '800', color: 'var(--color-text-muted)', letterSpacing: '0.05em', marginBottom: '2px' }}>COMPETITORS REGISTERED</div>
                <div className="dash-stat-value" style={{ fontSize: 'var(--text-2xl)', color: '#38bdf8', lineHeight: '1', textShadow: '0 0 12px rgba(56, 189, 248, 0.4)' }}>{competitorsRegistered.toLocaleString()}+</div>
              </div>
            </Card>
            ...
            <Card className="p-1" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', borderRadius: 'var(--radius-lg)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center' }}>
                <div style={{ fontSize: '10px', fontWeight: '800', color: 'var(--color-text-muted)', letterSpacing: '0.05em', marginBottom: '2px' }}>PRIZES DISTRIBUTED</div>
                <div className="dash-stat-value" style={{ fontSize: 'var(--text-2xl)', color: '#facc15', lineHeight: '1', textShadow: '0 0 12px rgba(250, 204, 21, 0.4)' }}>{prizesDistributed.toLocaleString()}rs+</div>
              </div>
            </Card>
            ...
            <Card className="p-1" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px', borderRadius: 'var(--radius-lg)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center' }}>
                <div style={{ fontSize: '10px', fontWeight: '800', color: 'var(--color-text-muted)', letterSpacing: '0.05em', marginBottom: '2px' }}>ACTIVE SERVERS</div>
                <div className="dash-stat-value" style={{ fontSize: 'var(--text-2xl)', color: '#3cc83c', lineHeight: '1', textShadow: '0 0 12px rgba(60, 200, 60, 0.4)' }}>{activeServers} ONLINE</div>
              </div>
            </Card>
