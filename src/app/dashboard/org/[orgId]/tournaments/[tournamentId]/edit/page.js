...
export default function EditTournamentPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (updateError && (updateError.code === '42703' || updateError.message.includes('short_description') || updateError.message.includes('auto_select_count') || updateError.message.includes('require_discord') || updateError.message.includes('require_follow') || updateError.message.includes('prizepool'))) {
